...
class UpdateRecommend extends Component {
    ...
    handleAdd = (posisi, candidate, id, lamapglmn) => {
        const rec = {
            candidate: candidate,
            posisi: posisi,
            lamapglmn: lamapglmn,
                    ...
                    <ModalBody>
                        <Form>
                                    ...
                                    this.state.dataCd.map(
                                        (dataCd, index) => (
                                            <FormGroup row key={dataCd.id}>
                                                ...
                                                <Col md="3" style={{ alignSelf: "center" }}>
                                                    <Input disabled required type="text" name="lamapglmn" id="lamapglmn"
                                                        defaultValue={dataCd.lamapglmn} />
                                                </Col>
                            ...
                            <FormGroup row>
                                ...
                                <Col md="3" style={{ alignSelf: "center" }}>
                                    <Input required autoComplete="off" type="text" name="lamapglmn" id="lamapglmn"
                                        value={this.state.lamapglmn} onChange={this.dataChange} />
                                </Col>
                                {/* } */}
                                {
                                    <Col md="1" style={{ alignSelf: "center" }}>
                                        <FormGroup>
                                            ...
                                            <Button className="btn-pill btn-sm  btn-shine"
                                                ...
                                                onClick={() => { this.handleAdd(this.state.valuePosisi, this.props.namaKandidat, this.props.idKandidat, this.state.lamapglmn) }}
                                            >
