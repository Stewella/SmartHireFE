...
class EditLock extends Component {
    ...
    findLockData = (id) => {
        axios.get(SERVICE.JAVA_SERVICE + "/lock-user/getBy/" + id)
            .then(response => {
                this.setState({ lockData: response.data.data });
                this.setState({
                    tglMulai: this.state.lockData.tglMulai,
                    tglSelesai: this.state.lockData.tglSelesai,
                    kodeDetkeb: this.state.lockData.kodeDetkeb,
                    keterangan: this.state.lockData.keterangan
                })
                axios.get(SERVICE.JAVA_SERVICE + "/detailkeb/bykode/" + response.data.data.kodeDetkeb)
    ...
    render() {
        return (
            <span>
                ...
                >
                    <ModalHeader toggle={this.props.toggle}>EDIT LOCK</ModalHeader>
                    <ModalBody>
                        <Row form>
                            <Col md="12">
                                <Form>
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col sm={10}>
                                            <Input disabled required type="text" name="kode" id="kode"
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col sm={10}>
                                            <Input disabled autoComplete="off" type="date" name="tglMulai" id="tglMulai"
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col sm={10}>
                                            <Input disabled type="textarea" name="keterangan" id="keterangan" value={this.state.keterangan}
